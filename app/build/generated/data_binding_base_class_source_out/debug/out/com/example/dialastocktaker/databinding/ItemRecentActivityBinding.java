...
public final class ItemRecentActivityBinding implements ViewBinding {
  ...
  private ItemRecentActivityBinding(@NonNull CardView rootView, @NonNull TextView tvActivityTime,
  ...
  public static ItemRecentActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecentActivityBinding((CardView) rootView, tvActivityTime, tvActivityTitle);
    }
