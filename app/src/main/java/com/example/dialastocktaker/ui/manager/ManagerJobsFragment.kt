...
import com.example.dialastocktaker.databinding.FragmentManagerJobsBinding
...
class ManagerJobsFragment : Fragment() {
    private var _binding: FragmentManagerJobsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentManagerJobsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun loadMockData() {
        ...
        val jobs = listOf(
            ...
            JobItem(
                id = "ST-2023-042",
                location = "Main Warehouse, 123 Storage St",
                date = dateFormat.parse("2023-04-28") ?: Date(),
                team = "Team Alpha",
                status = "Completed"
            )
        )
