...
import com.example.dialastocktaker.databinding.FragmentScannerJobsBinding
...
class ScannerJobsFragment : Fragment() {
    private var _binding: FragmentScannerJobsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentScannerJobsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnStartScan.setOnClickListener {
            Toast.makeText(requireContext(), "Start Scan functionality would appear here", Toast.LENGTH_SHORT).show()
        }
