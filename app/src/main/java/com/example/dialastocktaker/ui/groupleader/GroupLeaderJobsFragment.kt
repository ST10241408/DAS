...
import com.example.dialastocktaker.databinding.FragmentGroupLeaderJobsBinding
...
class GroupLeaderJobsFragment : Fragment() {
    private var _binding: FragmentGroupLeaderJobsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGroupLeaderJobsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnUpdateStatus.setOnClickListener {
            Toast.makeText(requireContext(), "Update Status functionality would appear here", Toast.LENGTH_SHORT).show()
        }
